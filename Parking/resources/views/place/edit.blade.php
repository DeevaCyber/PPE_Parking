...
<html>
  ...
  <body>
    ...
    <form action="{{ route('place.update', $place->codeplace) }}" method="post">
      @csrf
      @method('PUT')
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
            ...
            <input type="text" name="place" value="{{ $place->codeplace }}" class="form-control" placeholder="ENTREZ LE NOM">
          </div>
        </div>
